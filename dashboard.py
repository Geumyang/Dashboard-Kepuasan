...
st.info(f"💡 **Kesimpulan:** Konsentrasi bisnis terpusat di kawasan tenggara Brasil (SP, RJ, MG). Ekspansi ke wilayah utara dan timur laut merupakan peluang pertumbuhan bisnis yang belum dioptimalkan.")
