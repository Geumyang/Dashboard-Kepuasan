...
st.sidebar.markdown("---")
st.sidebar.caption("Sumber Data: E-Commerce Dataset 2017–2018")
...
with col2:
    st.metric("💰 Total Pendapatan", f"$ {df['payment_value'].sum():,.0f}")
with col3:
...
st.info(f"💡 **Kesimpulan:** Konsentrasi bisnis terpusat di kawasan tenggara Brazil (SP, RJ, MG). Ekspansi ke wilayah utara dan timur laut merupakan peluang pertumbuhan bisnis yang belum dioptimalkan.")
...
# ═══════════════════════════════════════════════
st.subheader("👥 Pertanyaan 4: Bagaimana segmentasi pelanggan berdasarkan RFM Analysis pada periode 2017–2018?")
...
st.info(f"💡 **Kesimpulan:** Sebagian besar pelanggan masuk dalam segmen **Potensial Loyalits** dan **Loyal Customers**. Diperlukan strategi retensi seperti email remarketing, diskon loyalitas, dan program referral untuk mengkonversi segmen ini menjadi pelanggan **Champions**.")
